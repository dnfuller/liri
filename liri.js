...
var request = require("request"); // npm install require
var fs = require('fs');

// inform user of what to type in and capture user input
...
function fetchTweets() {
  ...
  console.log("Tweets are on the way!");
  // load keys from imported keys.js
...
function doWhatItSays() {
  console.log("A view of random.txt now");
